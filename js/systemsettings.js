...
function SystemSettings($parent) {
    ...
    this.onGuidedTour = function() {
        return _onGuidedTour;
    }
    this.date = function() {
        return _date;
    }
    this.fullscreenCount = function() {
        return _fullscreenCount;
    }
    ...
    this.bluetoothVisible = function() {
        return _bluetoothVisible;
    }
    this.mute = function() {
        return _mute;
    }
