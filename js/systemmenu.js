...
function SystemMenu($parent) {
    ...
    this.addScrolling = function() {
        ...
        $('#menu .scroll-up').bind('mouseover', function() {
            scrollingUp = true;
            scrollUp();
        });
        $('#menu .scroll-down').bind('mouseover', function() {
            scrollingDown = true;
            scrollDown();
        });
        $('#menu .scroll-up').bind('mouseout', function() {
            _this.stopScrolling()
        });
        $('#menu .scroll-down').bind('mouseout', function() {
            _this.stopScrolling()
        });
        ...
        switch ($menu) {
            ...
            case 'home':
                ...
                if (!div.is(':visible')) {
                    if (fileSystem.isMinified()) {
                        if (fileSystem.isMaximised()) {
                            systemSettings.increaseFullscreen();
                        }
            ...
            case 'firefox':
                ...
                if (!div.is(':visible')) {
                    ...
                    if (_parent.firefoxSystem.isMaximised()) {
            ...
            case 'shotwell':
                ...
                if (!div.is(':visible')) {
                    ...
                    if (_parent.shotwellSystem.isMaximised()) {
                        _parent.systemSettings.increaseFullscreen();
                    }
                }
            ...
            case 'email':
                ...
                if (!div.is(':visible')) {
                    ...
                    if (_parent.emailSystem.isMaximised()) {
                        _parent.systemSettings.increaseFullscreen();
                    }
                }
            ...
            case 'movieplayer':
                ...
                if (!div.is(':visible')) {
                    ...
                    if (_parent.moviePlayerSystem.isMaximised()) {
                        _parent.systemSettings.increaseFullscreen();
                    }
                }
